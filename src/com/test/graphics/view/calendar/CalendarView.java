package com.test.graphics.view.calendar;
...
private final String TAG = CalendarView.class.getSimpleName();
	...
	private final float DEFAULT_TEXT_SIZE_YEAR = 50F;
	private final float DEFAULT_TEXT_SIZE_WEEK = 50F;
	private final float DEFAULT_TEXT_SIZE_DAY = 40F;
	...
	/**今天的日期方块的背景颜色*/
	private int colorTodayBackground = Color.rgb(201, 77, 66);
